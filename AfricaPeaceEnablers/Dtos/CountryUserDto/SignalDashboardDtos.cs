namespace AfricaPeaceEnablers.Dtos.CountryUserDto
{
    ...
    public class PeaceStressTestDashboardDto
    {
        ...
        public decimal APEM { get; set; }

        public decimal CountryScore { get; set; }

        public decimal APEMDirectionalMovement { get; set; }

        public string APEMCondition { get; set; } = string.Empty;

        public string APEMDescriptor { get; set; } = string.Empty;

        public string APEMStrategicAction { get; set; } = string.Empty;
