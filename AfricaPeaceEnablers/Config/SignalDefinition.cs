namespace AfricaPeaceEnablers.Config
{
    ...
    public sealed class SignalDefinition
    {
        ...
        {
            new() { Code = "APEM", Name = "Peace Equilibrium Metric", Mode = SignalMode.StressTest, HigherIsRisk = false },
            ...
            new() { Code = "APEM-DM", Name = "APEM Directional Movement", Mode = SignalMode.StressTest },
