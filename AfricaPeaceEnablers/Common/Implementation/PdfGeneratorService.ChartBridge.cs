...
namespace AfricaPeaceEnablers.Common.Implementation
{
    ...
    public partial class PdfGeneratorService
    {
            ...
            SKCanvas c, QPDF.Size s, List<KpiChartItem> data, int offset)
        {
            ...
            {
                Color = SKColor.Parse("#6B7F62").WithAlpha(100), StrokeWidth = 0.9f,
            ...
            SKCanvas c, QPDF.Size s, List<PillarChartItem> pillars)
        {
            ...
            using var title = new SKPaint { Color = SKColor.Parse("#1B3022"), TextSize = 10f, IsAntialias = true, TextAlign = SKTextAlign.Center, FakeBoldText = true };
            ...
            using var fill = new SKPaint { Color = SKColor.Parse("#1B3022"), Style = SKPaintStyle.Fill, IsAntialias = true };
            ...
            SKCanvas c, QPDF.Size s, List<PillarChartItem> pillars)
        {
            ...
            for (int i = 0; i < sorted.Count; i++)
            {
                ...
                if (i % 2 == 0) c.DrawRect(new SKRect(0, y, s.Width, y + rowH), new SKPaint { Color = SKColor.Parse("#F7F4EE") });
            ...
            List<PeerCountryHistoryReportDto> countries, AiCountrySummeryDto countryDetails)
        {
            ...
            for (int i = 0; i < countries.Count; i++)
            {
                ...
                using var txt = new SKPaint { Color = SKColor.Parse(isMain ? "#1B3022" : "#444444"), TextSize = 9f, IsAntialias = true, FakeBoldText = isMain };
            ...
            SKCanvas c, QPDF.Size s, List<PeerCountryHistoryReportDto> all)
        {
            ...
            string[] palette = { "1B3022","6B7F62","6B7F62","BFA16D","E05252","5A6B5E","3C5A64" };
            ...
            for (int i = 0; i < byRegion.Count; i++)
            {
                ...
                if (i % 2 == 0) c.DrawRect(new SKRect(0, y, s.Width, y + barH), new SKPaint { Color = SKColor.Parse("#F7F4EE") });
            ...
            List<(int Year, float Avg, bool HasData)> peerAvg)
        {
            ...
            // Peer lines
            string[] pal = { "BFA16D","6B7F62","3C5A64","FB8C00","5A6B5E","E05252" };
        ...
        {
            if (years.Count < 2) return;
            string[] pal = { "1B3022","6B7F62","6B7F62","BFA16D","F5A623","E05252","5A6B5E","3C5A64","6B7F62","FB8C00","3C5A64","8D6E63","E91E63","607D8B" };
        ...
        private static SKColor GetColorStatic(float v)
            => v >= 70 ? SKColor.Parse("#6B7F62") : v >= 40 ? SKColor.Parse("#F9A825") : SKColor.Parse("#C62828");
            ...
            List<PeerCountryHistoryReportDto> all)
        {
            ...
            string[] segColors = { "#D9534F", "#F0AD4E", "#A3AD91", "#6B7F62" };
            ...
            for (int i = 0; i < categoryOrder.Length; i++)
            {
                ...
                valPaint.Color = SKColor.Parse("#1B3022");
