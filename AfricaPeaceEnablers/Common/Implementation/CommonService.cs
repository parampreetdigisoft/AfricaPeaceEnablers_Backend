...
namespace AfricaPeaceEnablers.Common.Implementation
{
    public class CommonService : ICommonService
    {
        ...
        {
            var evidenceSummaryStaringLine = $"{countryName ?? "The country"} records an overall APEM score of {progress ?? 0}, reflecting performance across {pillarCount} pillars and {kpiCount} KPIs.";
